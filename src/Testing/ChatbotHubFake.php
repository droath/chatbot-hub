...
namespace Droath\ChatbotHub\Testing;
...
use Droath\ChatbotHub\Testing\Resources\FakeResource;
...
class ChatbotHubFake implements Fake
{
    protected ?ChatbotProvider $provider = null;
     ...
     */
    public function assertProvider(\Closure|ChatbotProvider $expected): void
    {
