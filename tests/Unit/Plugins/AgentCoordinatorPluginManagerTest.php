...
use Droath\ChatbotHub\Plugins\AgentPluginManager;
use Droath\ChatbotHub\Agents\Enums\AgentStrategy;
use Droath\ChatbotHub\Responses\ChatbotHubResponseMessage;
use Droath\ChatbotHub\Plugins\AgentCoordinatorPluginManager;
...
beforeEach(function () {
    $testNamespace = 'Droath\ChatbotHub\Tests\Fixtures\Plugins';
    $this->swap(
...
test('agent coordinator plugins using a parallel strategy', function () {
    ...
    ChatbotHub::fake(resourceCallback: function () use ($contentResponse, $metadataResponse, $coordinatorResponse) {
    ...
    /** @var \Droath\ChatbotHub\Plugins\AgentCoordinator\AgentCoordinatorPlugin $coordinator */
    ...
    expect($response)
        ...
        ->and($response->coordinatorResponse())->toBeInstanceOf(ChatbotHubResponseMessage::class);
});
