...
namespace Droath\ChatbotHub\Console\Commands;
...
class MemoryCleanupCommand extends Command
{
     ...
     */
    protected $signature = 'chatbot-hub:memory:cleanup {--dry-run : Show what would be cleaned without actually cleaning}';
