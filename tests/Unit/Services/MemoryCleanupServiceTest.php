...
it('can cleanup all configured memory strategies', function () {
    ...
    Config::set('chatbot-hub.memory.cleanup.strategies', ['database']);
...
it('filters configured strategies to only valid types', function () {
    Config::set('chatbot-hub.memory.cleanup.strategies', ['database', 'invalid_type', 'session']);
...
it('uses default strategy types when no config is provided', function () {
    ...
    Config::set('chatbot-hub.memory.cleanup.strategies', null);
